...
def eval_singleperson_pckh(model, fval, pval, afmat_val, headsize_val,
    ...
    # for zz in pred[-1][0]:
    #     print(zz)
    #     plt.scatter(zz[0]*250, zz[1]*250)
    # plt.savefig("mpii_pred.png")
    # print("common.mpii_tools.eval_singleperson_pckh   pred  86 ",pred)
    if win is not None:
        del pred[0]
    ...
    for b in range(num_blocks):
        ...
        # print("common.mpii_tools.eval_singleperson_pckh    y_pred   120 : ",y_pred)
